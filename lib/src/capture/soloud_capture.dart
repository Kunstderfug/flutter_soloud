...
/// [SoLoudCaptureStartResult.mirrorActive] after starting capture. Native
/// builds compile WavPack through `hook/build.dart`; the web WASM build
/// defines `NO_WAVPACK_LIBS` and does not expose input capture.
